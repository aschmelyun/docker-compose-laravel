...
<nav-circle>
 ...
 <instagram-icon class="-my-16 md:-my-8  xl:-my-16">
 </instagram-icon>
 <tiktok-icon class="-my-16 md:-my-8  xl:-my-16">
 </tiktok-icon>
 <youtube-icon class="-my-16 md:-my-8  xl:-my-16">
 </youtube-icon>
